...
kt_jvm_library(
    ...
    tags = ["maven_coordinates=com.github.adangel:summit-ast:{pom_version}", "manual"],
    deps = [
...
assemble_maven(
    ...
    project_url = "https://github.com/adangel/summit-ast",
    scm_url = "https://github.com/adangel/summit-ast.git",
